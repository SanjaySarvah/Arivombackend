...
$id = intval($input['id']);
$allowed = ['title','category','subcategory','subsubcategory','excerpt','content','image','author','slug','likes','created_at'];
$fields = []; $params = []; $types = "";
...
if ($stmt->execute()) echo json_encode(["status"=>"success","message"=>"Article updated"]);
